...
#endif
    public class ThirdPersonController2 : MonoBehaviourPunCallbacks
    {
        ...
        public GameObject PlayerFollowCamera2;
        public GameObject CinemachineCamTarget;
        public GameObject CinemachineCamTarget2;

        private void Start()
        {
            var cinemachineVirtualCameraObject = GameObject.Find("third person shoot");
            cinemachineVirtualCameraObject.GetComponent<CinemachineFreeLook>().Follow = GameObject.Find("CameraRoot").transform;
            cinemachineVirtualCameraObject.GetComponent<CinemachineFreeLook>().LookAt = GameObject.Find("CameraRoot").transform;
            CinemachineCamTarget = GameObject.Find("CameraRoot");
            ...
            CinemachineCamTarget2 = GameObject.Find("fpsRoot");
